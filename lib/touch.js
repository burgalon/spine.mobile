...
(function() {
  ...
  if ($.support.touch) {
    $('body').on('click', function(e) {
      var target;
      target = $(e.target);
      if (!((target.attr('href') != null) || target.is('input' || target.is('label'))) || window.preventClicks === true) {
        return e.preventDefault();
      }
    });
    $(function() {
      $('body').on('tap', 'input[type=submit]', function(e) {
        e.preventDefault();
      ...
      $('body').on('tap', function(e) {
        var target;
        target = $(e.target);
        if (!((target.attr('href') != null) || target.is('input' || target.is('label')))) {
          window.preventClicks = true;
          return setTimeout(function() {
            return window.preventClicks = false;
          }, 400);
        }
      });
      return $('body').on('tap', 'label', function(e) {
        e.preventDefault();
        return $("input#" + e.target.htmlFor).trigger('click');
      });
    });
  } else {
    $(function() {
